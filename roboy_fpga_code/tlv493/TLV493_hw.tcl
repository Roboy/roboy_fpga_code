...
# Sat Mar 02 14:49:54 CET 2019
# DO NOT MODIFY


# 
# TLV493 "TLV493" v1.0
# Simon Trendel 2019.03.02.14:49:54
# automatically configures and retrieves magnet data from arbitray amount of tlv sensors via deparate i2c lines
# 
...
# module TLV493
# 
set_module_property DESCRIPTION "automatically configures and retrieves magnet data from arbitray amount of tlv sensors via deparate i2c lines"
...
add_fileset_file TLV493.sv SYSTEM_VERILOG PATH ip/roboy_fpga_code/tlv493/TLV493.sv TOP_LEVEL_FILE
...
add_interface_port conduit_end scl scl Output NUMBER_OF_SENSORS
add_interface_port conduit_end sda sda Bidir NUMBER_OF_SENSORS
